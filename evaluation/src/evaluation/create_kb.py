...
def clean_docs() -> None:
    console.print("Cleaning 'documents' directory")
    docs = Path("documents")
...
def create_kb(
    ...
    table = Table("DOCUMENT", "URL")

    for url in EVALUATION_KB_DOCS:
        console.print(f"Loading document '{url}'")
    ...
    console.print("Successfully created knowledge base:")
    console.print(table)
